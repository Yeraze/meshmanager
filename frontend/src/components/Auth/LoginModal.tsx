...
export function LoginModal() {
  ...
  // When local auth is disabled, skip to SSO-only mode (unless first-user setup)
  const showLocalForm = !localAuthDisabled || setupRequired
  ...
  return (
    <div className={styles.overlay} onClick={handleClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        {localAuthDisabled && !oidcEnabled && !setupRequired && (
          <div className={styles.error}>
            Local authentication is disabled but SSO is not configured. Please contact your administrator.
          </div>
        )}
        ...
        {oidcEnabled && !setupRequired && mode !== 'totp' && (
          <>
            {showLocalForm && mode === 'login' && (
        ...
        {showRegisterOption && !setupRequired && !localAuthDisabled && mode !== 'totp' && (
